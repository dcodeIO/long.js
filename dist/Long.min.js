...
*/
var q=!0,r=!1;
(function(s){function b(a,b,d){this.low=a|0;this.high=b|0;this.unsigned=!!d}b.isLong=function(a){return(a&&a instanceof b)===q};var t={},u={};b.fromInt=function(a,c){var d;if(c){a>>>=0;if(0<=a&&256>a&&(d=u[a]))return d;d=new b(a,0>(a|0)?-1:0,q);0<=a&&256>a&&(u[a]=d)}else{a|=0;if(-128<=a&&128>a&&(d=t[a]))return d;d=new b(a,0>a?-1:0,r);-128<=a&&128>a&&(t[a]=d)}return d};b.fromNumber=function(a,c){c=!!c;return isNaN(a)||!isFinite(a)?b.ZERO:!c&&a<=-v?b.MIN_VALUE:!c&&a+1>=v?b.MAX_VALUE:c&&a>=w?b.MAX_UNSIGNED_VALUE:
0>a?b.fromNumber(-a,c).negate():new b(a%l|0,a/l|0,c)};b.fromBits=function(a,c,d){return new b(a,c,d)};b.fromString=function(a,c,d){if(0===a.length)throw Error("number format error: empty string");if("NaN"===a||"Infinity"===a||"+Infinity"===a||"-Infinity"===a)return b.ZERO;"number"===typeof c&&(d=c,c=r);d=d||10;if(2>d||36<d)throw Error("radix out of range: "+d);var e;if(0<(e=a.indexOf("-")))throw Error('number format error: interior "-" character: '+a);if(0===e)return b.fromString(a.substring(1),c,
d).negate();e=b.fromNumber(Math.pow(d,8));for(var f=b.ZERO,g=0;g<a.length;g+=8){var k=Math.min(8,a.length-g),m=parseInt(a.substring(g,g+k),d);8>k?(k=b.fromNumber(Math.pow(d,k)),f=f.multiply(k).add(b.fromNumber(m))):(f=f.multiply(e),f=f.add(b.fromNumber(m)))}f.unsigned=c;return f};b.valueOf=function(a){return"number"===typeof a?b.fromNumber(a):"string"===typeof a?b.fromString(a):b.isLong(a)?a:b(a.low,a.high,a.unsigned)};var l=4294967296,w=l*l,v=w/2,x=b.fromInt(16777216);b.ZERO=b.fromInt(0);b.UZERO=
b.fromInt(0,q);b.ONE=b.fromInt(1);b.UONE=b.fromInt(1,q);b.NEG_ONE=b.fromInt(-1);b.MAX_VALUE=b.fromBits(-1,2147483647,r);b.MAX_UNSIGNED_VALUE=b.fromBits(-1,-1,q);b.MIN_VALUE=b.fromBits(0,-2147483648,r);b.prototype.toInt=function(){return this.unsigned?this.low>>>0:this.low};b.prototype.toNumber=function(){return this.unsigned?(this.high>>>0)*l+(this.low>>>0):this.high*l+(this.low>>>0)};b.prototype.toString=function(a){a=a||10;if(2>a||36<a)throw RangeError("radix out of range: "+a);if(this.isZero())return"0";
...
0<=this.high};b.prototype.isOdd=function(){return 1===(this.low&1)};b.prototype.equals=function(a){b.isLong(a)||(a=b.valueOf(a));return this.unsigned!==a.unsigned&&this.high>>>31!==a.high>>>31?r:this.high===a.high&&this.low===a.low};b.prototype.notEquals=function(a){b.isLong(a)||(a=b.valueOf(a));return!this.equals(a)};b.prototype.lessThan=function(a){b.isLong(a)||(a=b.valueOf(a));return 0>this.compare(a)};b.prototype.lessThanOrEqual=function(a){b.isLong(a)||(a=b.valueOf(a));return 0>=this.compare(a)};
b.prototype.greaterThan=function(a){b.isLong(a)||(a=b.valueOf(a));return 0<this.compare(a)};b.prototype.greaterThanOrEqual=function(a){return 0<=this.compare(a)};b.prototype.compare=function(a){if(this.equals(a))return 0;var b=this.isNegative(),d=a.isNegative();return b&&!d?-1:!b&&d?1:!this.unsigned?this.subtract(a).isNegative()?-1:1:a.high>>>0>this.high>>>0||a.high===this.high&&a.low>>>0>this.low>>>0?-1:1};b.prototype.negate=function(){return!this.unsigned&&this.equals(b.MIN_VALUE)?b.MIN_VALUE:this.not().add(b.ONE)};
...
function(){return!this.unsigned?this:new b(this.low,this.high,r)};b.prototype.toUnsigned=function(){return this.unsigned?this:new b(this.low,this.high,q)};"undefined"!==typeof module&&module.exports?module.exports=b:"function"===typeof define&&define.amd?define(function(){return b}):(s.dcodeIO=s.dcodeIO||{}).Long=b})(this);})();
